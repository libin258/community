...
public class MessageController implements CommunityConstant {
    ...
    public String getNoticeList(Model model){
        ...
        // 查询关注类通知
        message = messageService.findLatesNotice(user.getId(),TOPIC_FOLLOE);
        if(message != null){
            Map<String,Object> messageVO = new HashMap<>();
            messageVO.put("message",message);
            ...
            int unread = messageService.findNoticeUnread(user.getId(),TOPIC_FOLLOE);
            messageVO.put("unread",unread);
    ...
    public String getNoticesDetail(@PathVariable("topic") String topic , Page page ,Model model){
        ...
        model.addAttribute("notices" , listVo);
